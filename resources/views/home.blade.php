...
@section('content')
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('assets/images/logo.png') }}" alt="" width="96px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="header01">
                <ul class="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 me-4">
                    ...
                    <li class="nav-item me-4"> <a href="#">Company</a></li>
                    <li class="nav-item me-4"> <a href="#">Services</a></li>
                    <li class="nav-item me-4"> <a href="#">Testimonials</a></li>
                </ul>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="text-muted mb-5">Old Shantinagor,Dhaka</p>
                    <h4 class="fw-bold">Contact Us</h4>
                    <p class="text-muted mb-1">mdsharifhosen762@gmail.com</p>
                    <p class="text-muted mb-0">01728737552</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <form action="#">
    ...
    <footer class="py-5 bg-light">
        <div class="container text-center pb-5 border-bottom">
            ...
            <div>
                <a class="d-inline-block me-4" href="https://www.facebook.com/MSharifHosen39/">
                    <img src="{{ asset('/assets/images/facebook.svg') }}">
                </a>
                <a class="d-inline-block me-4" href="https://x.com/MdSharifHosen39">
                    <img src="{{ asset('/assets/images/twitter.svg') }}">
                </a>
                <a class="d-inline-block me-4" href="https://github.com/Md-Sharif-Hosen">
                    <img src="{{ asset('/assets/images/github.svg') }}">
                </a>
                <a class="d-inline-block me-4" href="https://www.instagram.com/mdsharifhosen39/">
                    <img src="{{ asset('/assets/images/instagram.svg') }}">
                </a>
                <a class="d-inline-block" href="https://www.linkedin.com/in/mdsharifhosen39/">
        ...
        <div class="mb-5"></div>
        <div class="container">
            <p class="text-center">All rights reserved © Sharif Hosen 2023-2024</p>
        </div>
    </footer>
@endsection
